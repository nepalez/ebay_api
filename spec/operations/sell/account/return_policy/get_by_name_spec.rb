RSpec.describe EbayAPI, ".sell.account.return_policy.get_by_name" do
  ...
  context "success" do
    let(:response) do
      open_fixture_file "sell/account/return_policy/get_by_name/success"
    end

    let(:policy) do
      yaml_fixture_file \
        "sell/account/return_policy/get_by_name/success.yml"
    end
